...
function AddTitle() {
  ...
  const submitTitle = (e) => {
    ...
    formData.append("producer", titleInput.producer);
    formData.append("price", titleInput.price);
    formData.append("rating", titleInput.rating);
    formData.append("distributor", titleInput.distributor);
  ...
  useEffect(() => {
    document.title = "ReelRush | New Title";
                ...
                <div className='addTitleGroup'>
                  <div className="addTitleField">
                    <div className="addTitleGroupField">
                      ...
                      <input type="text" name="producer" onChange={handleInput} value={titleInput.producer} className="form-control" />
                    </div>
                    <span>{error.producer}</span>
                  </div>
                  <div className="addTitleField">
                    <div className="addTitleGroupField">
                      <label>distributor</label>
                      <input type="text" name="distributor" onChange={handleInput} value={titleInput.distributor} className="form-control"/>
                    </div>
                    <span>{error.distributor}</span>
                  </div>
                  <div className="addTitleField">
                    <div className="addTitleGroupField">
                      <label>Price</label>

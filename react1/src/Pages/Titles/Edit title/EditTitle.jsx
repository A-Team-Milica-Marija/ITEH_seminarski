...
function EditTitle(props) {
  ...
  useEffect(() => {
    document.title = "ReelRush | Edit Title";
              ...
              {/* Details Tab Fields */}
                <div className="editTitleField">
                  <div>
                    ...
                    <input type="text" name="producer" onChange={handleInput} value={titleInput.producer}/>
                  </div>
                  <span className="text-danger">{error.producer}</span>
                </div>
                <div className="editTitleField">
                  <div>
                    <label>Price</label>
                ...
                <div className="editTitleField">
                  <div>
                    ...
                    <input type="text" name="distributor" onChange={handleInput} value={titleInput.distributor} />
                  </div>
                  <span className="text-danger">{error.distributor}</span>
                </div>
              </div>
             <div className='editTitleColumn'>
               <div id='editTitleImg'>
